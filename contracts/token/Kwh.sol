 ...
 */
contract Kwh is ERC20, LoggingErrors {
  ...
  string public constant name = 'AGL Reward Tokens Pegged to Kw/h';
  uint public constant decimals = 18;
  uint public constant aglReward = 1;  // Users are rewarded with 1 token
  ...
  mapping (address => bool) activePrograms_;
